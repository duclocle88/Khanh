...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>khanhnp chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Đăng Ký Kênh YouTube khanhnp để xem video mới nhất nhé<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "khanhnp", HidePremium = false, IntroText = "khanhnp⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
OrionLib:MakeNotification({
    Name = "khanhnp",
    Content = "Đăng Ký Kênh YouTube khanhnp nhé💕",
    Image = "rbxassetid://8192162908",
    Time = 10
})
